...
Предложенный интерфейс работы с программой отвергаю, как, по моему, противоречащий осальному функционалу задачи, в замен предлагаю следующий CLI-интерфейс для загрузки данных, обучения и валидации моделей.
